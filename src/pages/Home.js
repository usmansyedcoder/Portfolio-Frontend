      ...
      <section className={`hero ${isVisible ? 'visible' : ''}`}>
        <div className="hero-content">
          <div className="hero-text">
            ...
            <h2 className="title">
              <span className="typed-text">Full Stack MERN Developer</span>
            </h2>
          ...
          <div className="tech-stack-container">
              ...
              <div className="mern-grid">
                  ...
                  <div className="mern-info">
                    ...
                    <div className="skill-level">
                      <div className="level-bar">
                        <div className="level-progress" style={{ width: '90%' }}></div>
                      </div>
                ...
                <div className="mern-card express-card">
                  ...
                  <div className="mern-info">
                    ...
                    <div className="skill-level">
                      <div className="level-bar">
                        <div className="level-progress" style={{ width: '85%' }}></div>
                      </div>
                ...
                <div className="mern-card react-card">
                  ...
                  <div className="mern-info">
                    ...
                    <div className="skill-level">
                      <div className="level-bar">
                        <div className="level-progress" style={{ width: '95%' }}></div>
                      </div>
                ...
                <div className="mern-card firebase-card">
                  ...
                  <div className="mern-info">
                    ...
                    <div className="skill-level">
                      <div className="level-bar">
                        <div className="level-progress" style={{ width: '88%' }}></div>
                      </div>
                ...
                <div className="mern-card vite-card">
                  ...
                  <div className="mern-info">
                    ...
                    <div className="skill-level">
                      <div className="level-bar">
                        <div className="level-progress" style={{ width: '92%' }}></div>
                      </div>
            ...
            <div className="other-tech-section">
              ...
              <div className="tech-bubble-grid">
                <div className="tech-bubble" style={{ '--tech-color': '#3178C6' }}>
                  <div className="bubble-icon">🔷</div>
                  <span className="bubble-text">TypeScript</span>
                  <div className="bubble-glow"></div>
                </div>

                <div className="tech-bubble" style={{ '--tech-color': '#02569B' }}>
                  <div className="bubble-icon">📱</div>
                  <span className="bubble-text">Flutter</span>
                  <div className="bubble-glow"></div>
                </div>

                <div className="tech-bubble" style={{ '--tech-color': '#3776AB' }}>
                  <div className="bubble-icon">🐍</div>
                  <span className="bubble-text">Python</span>
                  <div className="bubble-glow"></div>
                </div>

                <div className="tech-bubble" style={{ '--tech-color': '#F7DF1E' }}>
                  <div className="bubble-icon">📜</div>
                  <span className="bubble-text">JavaScript</span>
                  <div className="bubble-glow"></div>
                </div>

                <div className="tech-bubble" style={{ '--tech-color': '#E34F26' }}>
                  <div className="bubble-icon">🌐</div>
                  <span className="bubble-text">HTML5</span>
                  <div className="bubble-glow"></div>
                </div>

                <div className="tech-bubble" style={{ '--tech-color': '#1572B6' }}>
                  <div className="bubble-icon">🎨</div>
                  <span className="bubble-text">CSS3</span>
                  <div className="bubble-glow"></div>
                </div>

                <div className="tech-bubble" style={{ '--tech-color': '#764ABC' }}>
                  <div className="bubble-icon">🔄</div>
                  <span className="bubble-text">Redux</span>
                  <div className="bubble-glow"></div>
                </div>

                <div className="tech-bubble" style={{ '--tech-color': '#339933' }}>
                  <div className="bubble-icon">📊</div>
              ...
              <div className="service-card web-dev-card">
                <div className="service-card-inner">
                  <div className="service-card-front">
                    ...
                    <p className="service-description">Modern, responsive web applications with cutting-edge technologies</p>
                  </div>
              ...
              <div className="service-card mobile-dev-card">
                <div className="service-card-inner">
                  <div className="service-card-front">
                    ...
                    <p className="service-description">Cross-platform mobile solutions for iOS and Android</p>
                  </div>
                  <div className="service-card-back">
                    <div className="service-details">
              ...
              <div className="service-card flutter-card">
                <div className="service-card-inner">
                  <div className="service-card-front">
                    ...
                    <p className="service-description">Beautiful native apps with single codebase</p>
                  </div>
                  <div className="service-card-back">
                    <div className="service-details">
              ...
              <div className="service-card backend-card">
                <div className="service-card-inner">
                  <div className="service-card-front">
                    ...
                    <p className="service-description">Robust server-side solutions and APIs</p>
                  </div>
                  <div className="service-card-back">
                    <div className="service-details">
              ...
              <div className="service-card database-card">
                <div className="service-card-inner">
                  <div className="service-card-front">
                    ...
                    <p className="service-description">Efficient data solutions and optimization</p>
                  </div>
                  <div className="service-card-back">
                    <div className="service-details">
              ...
              <div className="service-card design-card">
                <div className="service-card-inner">
                  <div className="service-card-front">
                    ...
                    <h3>UI/UX Design</h3>
                    <p className="service-description">Beautiful and intuitive user experiences</p>
                  </div>
                  <div className="service-card-back">
                    <div className="service-details">
                      <h4>UI/UX Design</h4>
